...
| Letta DTO extraction | Some high-coupling server DTOs still live in Android `:core`, including agents, messages, tools, blocks, MCP servers, projects/work items, steps, approval payloads, and transport frames. |
