    ...
    Scaffold(
        ...
        floatingActionButton = {
            FloatingActionButton(onClick = { showCreateDialog = true }) {
                Icon(Icons.Default.Add, stringResource(R.string.screen_providers_add_title))
            }
        },
    ) { paddingValues ->
            ...
            Row(
                ...
                Row {
                    IconButton(onClick = onEdit) {
                        Icon(Icons.Default.Edit, contentDescription = stringResource(R.string.screen_providers_edit_title))
                    }
