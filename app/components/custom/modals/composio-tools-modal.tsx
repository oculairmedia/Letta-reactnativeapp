...
export const ComposioToolsModal: FC<ComposioToolsModalProps> = observer(
  function ComposioToolsModal({ visible, onDismiss }) {
    ...
    const filteredComposioTools = useMemo(() => {
      ...
      return allComposioTools.filter((app) => {
        ...
        return (
          appName?.toLowerCase().includes(query) || appDescription?.toLowerCase().includes(query)
        )
      })
