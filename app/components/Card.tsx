...
const $containerPresets: Record<Presets, ThemedStyleArray<ViewStyle>> = {
  default: [
    ...
    $containerBase,
    (theme) => ({
      backgroundColor: theme.colors.elementColors.card.default.backgroundColor,
      borderColor: theme.colors.elementColors.card.default.borderColor,
    }),
  ],
  reversed: [
    $styles.row,
    $containerBase,
    (theme) => ({
      backgroundColor: theme.colors.elementColors.card.reversed.backgroundColor,
      borderColor: theme.colors.elementColors.card.reversed.borderColor,
    }),
  ],
}
...
const $headingPresets: Record<Presets, ThemedStyleArray<TextStyle>> = {
  default: [],
  reversed: [(theme) => ({ color: theme.colors.elementColors.card.reversed.heading })],
}

const $contentPresets: Record<Presets, ThemedStyleArray<TextStyle>> = {
  default: [],
  reversed: [(theme) => ({ color: theme.colors.elementColors.card.reversed.content })],
}

const $footerPresets: Record<Presets, ThemedStyleArray<TextStyle>> = {
  default: [],
  reversed: [(theme) => ({ color: theme.colors.elementColors.card.reversed.footer })],
}
