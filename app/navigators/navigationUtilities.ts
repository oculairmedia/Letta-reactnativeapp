...
import type { AgentDrawerParamList } from "./AgentDrawerNavigator"
import type { AgentNavigatorGroupParamList } from "./AgentNavigator"
import type { AgentTabParamList } from "./AgentTabNavigator"
...
export type RouteName =
  ...
  | keyof AgentTabParamList
  | keyof AgentDrawerParamList
  | keyof AgentNavigatorGroupParamList

/**
 * use this to navigate without the navigation
 * prop. If you have access to the navigation prop, do not use this.
 * @see {@link https://reactnavigation.org/docs/navigating-without-navigation-prop/}
 * @param {RouteName} name - The name of the route to navigate to.
 * @param {unknown} params - The params to pass to the route.
 */
export function navigate(name: RouteName, params?: unknown) {
  if (navigationRef.isReady()) {
    // @ts-expect-error
