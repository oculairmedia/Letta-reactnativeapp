...
export const useGetFolderFiles = (folderId: string) => {
    ...
    return useQuery({
        ...
        queryFn: () => lettaClient.folders.files.list(folderId).then(page => page.getPaginatedItems()),
    })
}
...
export const useGetAgentFolders = (agentId: string) => {
    ...
    return useQuery({
        ...
        queryFn: () => lettaClient.agents.folders.list(agentId).then(page => page.getPaginatedItems()),
    })
}
